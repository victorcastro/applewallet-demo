...
## Ajustes del XCFramework de HST
- HP2AppleSDK.xcframework
- HttpClient.xcframework
Deben estar importandos en el SBPPersonalBanking(AppTarget) y en SBPShared
* Por temas de copyright no se puede adjuntar los xcframeworks de HST dentro del proyecto
